                                    ...
                                    <div class="">
                                        ...
                                        <form method="">
                                            <div class="education-modal-input-group">
                                                <input class="" type="text" placeholder="School Name" value={selected.schoolName} name="" />
                                            </div>
                                            ...
                                            <div class="education-modal-input-group">
                                                <input class="" type="text" placeholder="Area of Study" value={selected.areaOfStudy} name="" />
                                            </div>
