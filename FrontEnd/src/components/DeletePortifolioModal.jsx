            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <div className="delete-portifolio-modal-page-wrapper ">
                            <div className="">
                                <div className="">
                                    <div className="">
                                        <h2 className="delete-portifolio-modal-education"></h2>
                                        {/* <form method="">
                                            <div className="delete-portifolio-modal-input-group">
                                                <input className="" type="text" placeholder="Email" name="" />
                                            </div>
                                            <div className="delete-portifolio-modal-input-group">
                                                <input className="" type="text" placeholder="Phone Number" name="" />
                                            </div>
