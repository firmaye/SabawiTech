            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <div class="emailandphone-modal-page-wrapper ">
                            <div class="">
                                <div class="">
                                    <div class="">
                                        <h2 class="emailandphone-modal-education"></h2>
                                        <form method="">
                                            <div class="emailandphone-modal-input-group">
                                                <input value={emailandphone.email} class="" type="text" placeholder="Email" name="" />
                                            </div>
                                            <div class="emailandphone-modal-input-group">
                                                <input value={emailandphone.phone} class="" type="text" placeholder="Phone Number" name="" />
                                            </div>
