                                    ...
                                    <div className="">
                                        ...
                                        <form method="">
                                            <div className="certification-modal-input-group">
                                                ...
                                                <input onChange={(data) => { setcertificatetitle(data.target.value) }} value={certificatetitle} className="" type="text" placeholder="Certificate Title" name="" />
                                            </div>

                                            <div className="certification-modal-input-group">
                                                <label>Certificate Provider</label>
                                                <input onChange={(data) => { setcertificateprovider(data.target.value) }} value={certificateprovider} className="" type="text" placeholder="Certificate Provider" name="" />
                                            </div>
                                            <div className="certification-modal-input-group">
                                                <label>Certificate Link</label>
                                                <input onChange={(data) => { setcertificatelink(data.target.value) }} value={certificatelink} className="" type="text" placeholder="Certificate Link" name="" />
                                            </div>
